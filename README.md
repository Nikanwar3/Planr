...
- **Deleting a project does not delete its tasks** — Tasks become project-less. This is a deliberate choice to avoid accidental data loss; a cascade-delete option could be added with a query param.
